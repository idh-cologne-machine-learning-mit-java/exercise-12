...
public class Titanic {
	...
	public static void main(String[] args) throws Exception {
		...
		MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder().seed(seed).list()
				.layer(new DenseLayer.Builder().nIn(numInputs).nOut(20).dropOut(0.2).build())
				.layer(new OutputLayer.Builder(LossFunctions.LossFunction.MCXENT).activation(Activation.SOFTMAX).nIn(20)
